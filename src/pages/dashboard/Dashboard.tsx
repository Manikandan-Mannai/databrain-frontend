...
//     switch (chartId.type) {
//       case "bar":
//         return <BarChart config={chartId.config} />;
//       case "line":
//         return <LineChart config={chartId.config} />;
//       case "pie":
//         return <PieChart config={chartId.config} />;
//       default:
//         return (
...
const DashboardPage: React.FC = () => {
  ...
  const renderChart = (chart: any) => {
    ...
    switch (chartId.type) {
      case "bar":
        return <BarChart config={chartId.config} data={data} />;
      case "line":
        return <LineChart config={chartId.config} data={data} />;
      case "pie":
        return <PieChart config={chartId.config} data={data} />;
      default:
        return (
          <Typography color="text.secondary">
            Unsupported chart type: {chartId.type}
